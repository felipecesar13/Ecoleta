...
var PointsController = /** @class */ (function () {
    ...
    PointsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, whatsapp, latitude, longitude, city, uf, items, image, trx, point, insertedIds, point_id, pointItems;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        pointItems = items.split(",").map(function (item_id) {
                            return {
                                item_id: item_id,
                                point_id: point_id
                            };
